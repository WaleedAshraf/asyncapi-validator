...
describe.only('slack', () => {
  let validator
  beforeEach(async () => {
    validator = await AsyncApiValidator.fromSource('./test/schemas/v2.4.0/slack.yml', {msgIdentifier: 'name'})
  })
  ...
  it('should validate botChanged message', () => {
    const validate = validator.validateByMessageId('botChanged', {
      type: 'bot_added',
      bot: {
        id: 'string',
        app_id: 'string',
  ...
  it('should validate channelDeleted message', () => {
    const validate = validator.validateByMessageId('channelDeleted', {
  ...
  it('should validate message', () => {
    const validate = validator.validateByMessageId('message', {
      type: 'message',
      user: 'string',
      channel: 'string',
      text: 'string',
