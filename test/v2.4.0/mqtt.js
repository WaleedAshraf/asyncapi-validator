...
describe('mqtt', () => {
  let validator
  beforeEach(async () => {
    validator = await AsyncApiValidator.fromSource('./test/schemas/v2.4.0/mqtt.yaml')
  })

  it('should validate alerts message', () => {
    const validate = validator.validateByMessageId('devices/alerts', [{
  ...
  it('should validate command_responses message', () => {
    const validate = validator.validateByMessageId('devices/command_responses', [{
  ...
  it('should validate commands message', () => {
    const validate = validator.validateByMessageId('devices/commands', {
  ...
  it('should validate config_requests message', () => {
    const validate = validator.validateByMessageId('devices/config_requests', [{
      timestamp: 0
    }])
    expect(validate).toStrictEqual(true)
  })
  ...
  it('should validate configs message', () => {
    const validate = validator.validateByMessageId('devices/configs', {
      configuration: {
  ...
  it('should validate errors message', () => {
    const validate = validator.validateByMessageId('devices/errors', {
  ...
  it('should validate installations message', () => {
    const validate = validator.validateByMessageId('devices/installations', {
      buildStamp: 'string',
